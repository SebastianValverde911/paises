...
import { IonSelectOption,  IonSelect, IonButton, IonContent, IonHeader, IonTitle, IonToolbar,IonButtons,IonBackButton,IonInput } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonSelectOption,  IonSelect, IonButton, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule,IonInput, IonButtons,IonBackButton]
})
